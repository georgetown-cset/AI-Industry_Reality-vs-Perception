...
ggplot(major_field_19.final, aes(x = DETAIL, 
  ...
  theme_gray(base_size = 10) +
  theme(legend.position="none") +
  labs(title = "AI Labor Demand Broken Down by Major in Each AI Occupation Field (2019)",
       subtitle = "(Top 5 Majors)",
       x = "AI Occupation Field",
...
ggplot(major_field_agg.final, aes(x = DETAIL, 
  ...
  theme_gray(base_size = 10) +
  theme(legend.position="none") +
  labs(title = "AI Labor Demand Broken Down by Major in Each AI Occupation Field (2010-2020)",
       subtitle = "(Top 5 Majors)",
       x = "AI Occupation Field",
       y = "% of Job Postings (in Each Sector)")
```
...
ggplot(trend_field, aes(x = year, y = job_count, color = DETAIL)) +
  ...
  scale_x_continuous(breaks=c(2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020)) +
  theme_gray(base_size = 15) +
  labs(title = "Trend in AI Labor Demand by AI Occupation Field",
       x = "Year",
       y = "Job Count") +
  scale_color_discrete("AI Occupation Field")
```
...
# Calculate total job count for each sector in each year by adding job count from all the AI occupation fields + null (which represents all non-AI jobs)
...
trend_sectorField %>%
  ...
  scale_x_continuous(breaks=c(2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020)) +
  theme_gray(base_size = 15) +
  labs(title = "Trend in AI Labor Demand by AI Occupation Field (Manufacturing)",
       x = "Year",
       y = "Job Count") +
  scale_color_discrete("AI Occupation Field")
...
trend_sectorField %>%
  ...
  scale_x_continuous(breaks=c(2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020)) +
  theme_gray(base_size = 15) +
  labs(title = "Trend in AI Labor Demand by AI Occupation Field (Professional, Scientific, and Technical Services)",
       x = "Year",
       y = "Job Count") +
  scale_color_discrete("AI Occupation Field")
...
trend_sectorField %>%
  ...
  scale_x_continuous(breaks=c(2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020)) +
  theme_gray(base_size = 15) +
  labs(title = "Trend in AI Labor Demand by AI Occupation Field (Transportation and Warehousing)",
       x = "Year",
       y = "Job Count") +
  scale_color_discrete("AI Occupation Field")
...
trend_sectorField %>%
  ...
  scale_x_continuous(breaks=c(2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020)) +
  theme_gray(base_size = 15) +
  labs(title = "Trend in AI Labor Demand by AI Occupation Field (Real Estate and Rental and Leasing)",
       x = "Year",
       y = "Job Count") +
  scale_color_discrete("AI Occupation Field")
...
trend_sectorField %>%
  ...
  scale_x_continuous(breaks=c(2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020)) +
  theme_gray(base_size = 15) +
  labs(title = "Trend in AI Labor Demand by AI Occupation Field (Information)",
       x = "Year",
       y = "Job Count") +
  scale_color_discrete("AI Occupation Field")
