...
ng_field %>%
  ...
  theme_gray(base_size = 15) +
  labs(title = "Total # of Job Postings by Northrop Grumman in Each AI Workforce Category (2019)",
...
ggplot(ng_trend, aes(x = year, y = job_count, color = DETAIL)) +
  ...
  theme_gray(base_size = 15) +
  labs(title = "Trend in AI Labor Demand by Northrop Grumman in Each AI Workforce Category",
       x = "Year",
       y = "Job Count") +
...
ng_trend_total %>%
  ...
  scale_x_continuous(breaks=c(2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020)) +
  theme_gray(base_size = 15) +
  labs(title = "Hiring Trend by Northrop Grumman",
       x = "Year",
       y = "Job Count") +
...
```{r}
ng_sector <- read_csv("ng_sector.csv")
...
ng_sector %>%
  ...
  ggplot(aes(x = canon_employer, y = percentage, fill = naics2_name)) +
    ...
    theme_gray(base_size = 15) +
    labs(title = "Percentage of Job Postings by Northrop Grumman in Each Sector (2019)",
         y = "Percentage",
         fill = "Sector") +
