...
verizon_field %>%
  ...
  theme_gray(base_size = 15) +
  labs(title = "Total # of Job Postings by Verizon in Each Occupation Field (2019)",
       x = "Occupation Field",
       y = "Job Count")
...
ggplot(verizon_trend, aes(x = year, y = job_count, color = DETAIL)) +
  ...
  theme_gray(base_size = 15) +
  labs(title = "Trend in AI Labor Demand by Verizon in Each Occupation Field",
       x = "Year",
       y = "Job Count") +
...
verizon_trend_total %>%
  ...
  scale_x_continuous(breaks=c(2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020)) +
  theme_gray(base_size = 15) +
  labs(title = "Trend in AI Labor Demand by Verizon",
       x = "Year",
       y = "Job Count") +
